...
# TEST PARAMETERS
(train_X, train_y), (test_X, test_y) = get_dataset(5000, 500)
EPOCHS = 1000
N_NEURONS = 150
...
t1 = threading.Thread(target=thread_SGD, args=(ret_SGD, activation1_sgd, "random"))
t2 = threading.Thread(target=thread_Rprop_minus, args=(ret_Rprop_minus, activation1_rprop_minus, "random"))
t3 = threading.Thread(target=thread_Rprop_plus, args=(ret_Rprop_plus, activation1_rprop_plus, "random"))
t4 = threading.Thread(target=thread_iRprop_minus, args=(ret_iRprop_minus, activation1_irprop_minus, "random"))
t5 = threading.Thread(target=thread_iRprop_plus, args=(ret_iRprop_plus, activation1_irprop_plus, "random"))
