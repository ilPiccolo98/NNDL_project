...
from neural_network_mnist import execute_SGD, execute_RProp_minus, execute_RProp_plus, execute_iRProp_plus, execute_iRProp_minus, Activation_LReLU, Activation_Sigmoid
